...
ezra({
  ...
  try {
    if (!_0x8621a4 || _0x8621a4.length === 0) {
      return _0x2e61d5("Example Usage: .follow 9230797*****.");
    }
    await _0x2e61d5("*ᴡᴀɪᴛ ᴛᴏғᴀɴ ᴍᴅ ɪs ғᴏʟʟᴏᴡ ᴛʜᴀᴛ ᴄʜᴀɴɴᴇʟ...*");
    const _0x386b0a = encodeURIComponent(_0x8621a4.join(" "));
    const _0x1ea92d = "https://whatsapp.com/channel/0029Vaw6yRaBPzjZPtVtA80A=" + _0x386b0a;
