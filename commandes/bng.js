...
zokou({
  ...
  try {
    if (!_0x588900 || _0x588900.length === 0) {
      return _0x5e7c97("Please insert the image url Njabulo will extract it for you.");
    }
...
zokou({
  ...
  try {
    if (!_0x2d283a || _0x2d283a.length === 0) {
      return _0x3baed4("Please describe your image and Njabulo BOT will generate it.");
    }
...
zokou({
  ...
  try {
    if (!_0x30c86a || _0x30c86a.length === 0) {
      return _0x16c607("Please describe your image Njabulo will generate it.");
    }
...
zokou({
  ...
  try {
    if (!_0x380eb1 || _0x380eb1.length === 0) {
      return _0x64dfea("Please describe your image and Njabulo will generate it.");
    }
