...
zokou({ nomCom: 'done',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*Tap Here To Join ᴛᴏғᴀɴ Telegram Chatroom* https://t.me/HacksManyMoreCheats`) 
...
zokou({ nomCom: 'update',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_ᴛᴏғᴀɴ is running on its latest vision_*`) 
...
zokou({ nomCom: 'done',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*Tap To Join ᴛᴏғᴀɴ WhatsApp Chartroom Group* https://whatsapp.com/channel/0029Vaw6yRaBPzjZPtVtA80A`) 
