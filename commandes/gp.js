...
zokou({
  ...
  for (let _0x398282 of _0x115598) {
    let _0x25a35f = "Tofan Md Broadcast\n\n❗*message* : " + _0x1360fc + "\n\n️‼️ *Author*: " + _0x271224;
...
zokou({
  ...
  _0x298913("ᴛᴀɴᴋs ʏᴏᴜ ɴᴇᴡ ᴍᴇᴍʙᴇʀ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ɢʀᴏᴜᴘ.");
});
...
zokou({
  ...
  try {
    ...
    await _0x2e5b52("A moment, *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴛᴏғᴀɴ ᴍᴅ* is compiling " + _0x267c2d.length + " contacts into a vcf...");
