...
> ©𝚃𝙾𝙵𝙰𝙽 𝙼𝙾𝙳𝚂
 ...
 `;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *𝚃𝙾𝙵𝙰𝙽*, déveloper Fredi Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
