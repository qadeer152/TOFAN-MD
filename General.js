...
zokou({ nomCom: "dev", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      ...
      { nom: "᚛Tofan2᚜", numero: "923151105391" },
      { nom: "Tofan3", numero: "923079749129" },
...
zokou({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `THANK YOU FOR CHOOSING TOFAN-MD,MAKE SURE YOU FOLLOW THESE LINKS. `},{quoted :ms})
